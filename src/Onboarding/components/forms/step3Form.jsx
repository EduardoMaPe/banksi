      ...
      <form onSubmit={(e) => nextPage(e)}>
        ...
        <div className="step1__form__input step1__form__input-gap step1__form__input-border">
          ...
          <div className="step1__form__input-flex step1__form__input-w">
            ...
            <input id="rfc" type="text" placeholder="Ingresa RFC del representante legal" />
          </div>
        </div>
        ...
        <div className="step1__form__input step1__form__input-gap step1__form__input-border">
          <div className="step1__form__input-flex step1__form__input-w">
            ...
            <input id="razon-social" type="text" placeholder="Ingresa la información solicitada" />
          </div>
          <div className="step1__form__input-flex step1__form__input-w">
            <label htmlFor="segundo-nombre">RFC de tu negocio</label>
            <input id="segundo-nombre" type="text" placeholder="Ingresa el RFC de tu negocio" />
          </div>
        </div>
